            ...
            <div class="row justify-content-center">
                <div class="col-md-10 mt-3">
                    <div class="card card-statistics p-3">
                        ...
                        <div class="card-body">
                            <form action="{{route('projects.showcase.update',$project->id)}}" method="POST" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="form-group">
                                    <label>Link</label>
                                    <input type="text" name="link" class="form-control" placeholder="Enter Project Link" value="{{$project->link}}">
                                    @if($errors->has('link'))
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="js-basic-single form-control" name="service_name">
                                        @foreach($services as $service)
                                            <option value="{{$service->id}}" @if($project->category_id == $service->id)  selected @endif>{{$service->name}}</option>
                                        @endforeach
                                    </select>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" rows="5S" name="description">
                                        {{$project->description}}
                                    </textarea>
