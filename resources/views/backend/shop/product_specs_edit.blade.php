                ...
                <div class="col-md-12 m-b-30">
                    ...
                    <div class="d-block d-sm-flex flex-nowrap align-items-center">
                        <div class="page-title mb-2 mb-sm-0">
                            <h1>Product Specifications edit</h1>
                        </div>
                    ...
                    <div class="card card-statistics p-3">
                        <div class="card-header">
                            <div class="card-heading">
                                <h4 class="card-title">{{$product->name}} Specifications Edit</h4>
                            </div>
                        </div>
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-12">
                                    <h4>Specifications Add</h4>
                                    ...
                                    <hr>
                                    <h4>Specifications edit</h4>
                                    <form action="{{route('shop.product.updatespecs',$product->id)}}" method="POST">
                                        @csrf
                                        <div class="form-row" id="inputfieldsContainertwo">
                                            @foreach($specifications as $specification)
                                                <div class="form-group col-md-8">
                                                    <input type="text" class="form-control" name="specification[]"
                                                           id="inputEmail4" placeholder="Responsibility" value="{{$specification->specification}}">
                                                    <input type="hidden" class="form-control" name="id[]"
                                                           id="inputEmail4" placeholder="Responsibility" value="{{$specification->id}}">
                                                </div>
                                                <div class="form-group col-md-4">
                                                    <a class="btn btn-primary" id="delete" href="{{route('shop.product.deletespecs',$specification->id)}}">Delete</a>
                                                </div>
                                            @endforeach
                                        </div>
                                        <button type="submit" class="btn btn-primary">Submit</button>
