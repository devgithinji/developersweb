                    ...
                    <div class="card card-statistics p-3">
                        <div class="card-header">
                            <div class="card-heading">
                                <h4 class="card-title">Career Create</h4>
                            </div>
                        </div>
                        <div class="card-body">
                            <div class="row">
    ...
    <script>
        window.onload = function () {
            $('#addMore').on('click', function (e) {
                e.preventDefault();
                $('#inputfieldsContainer').append('<div class="form-inline col-md-12 my-2"> <input type="email" class="form-control col-md-8" name="responsibility" id="inputEmail4" placeholder="Responsibility"> <button class="btn btn-primary ml-2" id="remove">remove</button> </div>')
            });
