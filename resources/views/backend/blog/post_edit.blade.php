                        ...
                        <div class="card-body">
                            <form action="{{route('post.update',$post->id)}}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    <label>Name</label>
                                    <input type="text" name="name" class="form-control" placeholder="Enter name" value="{{$post->title}}">
                                    @if($errors->has('name'))
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="custom-file">
                                        ...
                                        <label class="custom-file-label" id="product_img_label" for="">Choose post Image</label>
                                    </div>
                                    @if($errors->has('image'))
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea type="text" name="description" class="summernote"  id="summernote" rows="4" placeholder="Enter description">
                                        {{$post->desc}}
                                    </textarea>
