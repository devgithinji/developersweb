                    ...
                    <div class="card card-statistics">
                        <div class="card-header container-fluid">
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <a href="{{route('post.category.create')}}" class="btn btn-primary float-right">create
                                        new</a>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            @if($category->status == 0)
                                                <a type="button"
                                                   href="{{route('post.category.status.update',[$category->id,1])}}"
                                                   class="badge badge-danger-inverse">Inactive</a>
                                            @else
                                                <a type="button"
                                                   href="{{route('post.category.status.update',[$category->id,0])}}"
                                        ...
                                        <td class="text-center">
                                            <a href="{{route('post.category.edit',$category->id)}}"
                                               class="btn btn-round btn-inverse-success" type="button">edit</a>
                                            <a href="{{route('post.category.delete',$category->id)}}"
