                        ...
                        <div class="card-body">
                            <form action="{{route('services.update',[$service->id])}}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    <label>Name</label>
                                    <input type="text" name="name" class="form-control" placeholder="Enter name" value="{{$service->name}}">
                                    @if($errors->has('name'))
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="js-basic-single form-control" name="icon">
                                        @foreach($icons as $icon)
                                            <option value="{{$icon_full = 'fa '.$icon->name}}" @if($icon_full = 'fa '.$icon->name == $service->icon) selected @endif>{{$icon_full = 'fa '.$icon->name}}</option>
                                        @endforeach
                                    </select>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="custom-file">
                                        ...
                                        <label class="custom-file-label" id="product_img_label" for="">Choose service Image</label>
                                    </div>
                                    @if($errors->has('image'))
