                    ...
                    <div class="card card-statistics p-3">
                        <div class="card-header">
                            <div class="card-heading">
                                <h4 class="card-title">Service Price create</h4>
                            </div>
                        </div>
                        <div class="card-body">
                            <form action="{{route('prices.store')}}" method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" rows="2" name="desc1"></textarea>
                                    @if($errors->has('desc1'))
                                ...
                                <div class="form-group">
                                    <label>Description</label>
                                    <textarea class="form-control" rows="2" name="desc2"></textarea>
                                    @if($errors->has('desc2'))
                                ...
                                <div class="form-group">
                                    <label>Description</label>
                                    <textarea class="form-control" rows="2" name="desc3"></textarea>
                                    @if($errors->has('desc3'))
